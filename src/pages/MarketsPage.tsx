      ...
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 border-b border-slate-800 pb-6">
        ...
        <div className="relative w-full sm:w-72">
          ...
          <input
            ...
            className="w-full ps-9 pe-4 py-2 rounded-xl bg-slate-900 border border-slate-800 text-xs font-mono text-slate-200 placeholder-slate-500 focus:outline-hidden focus:border-blue-500"
          />
        </div>
      </div>
          ...
          <table className="w-full text-start border-collapse min-w-[700px]">
            <thead>
              <tr className="border-b border-slate-800 bg-slate-950/60 text-xs font-mono text-slate-400">
                ...
                <th className="py-3.5 px-4 text-start">Asset</th>
                <th className="py-3.5 px-4 text-end">Price</th>
                <th className="py-3.5 px-4 text-end">24h Change</th>
                <th className="py-3.5 px-4 text-end">Bid / Ask</th>
                <th className="py-3.5 px-4 text-end">Spread</th>
                  ...
                  >
                    ...
                    <td className="py-3.5 px-4 text-start">
                      <div className="flex items-center gap-2.5">
                        ...
                        <div>
                          <div className="font-bold text-slate-100 text-sm group-hover:text-blue-400 transition font-mono">
                            {asset.symbol}
                          </div>
                    ...
                    <td className="py-3.5 px-4 text-end font-bold text-slate-100 text-sm">
                    ...
                    <td className="py-3.5 px-4 text-end text-slate-300">
                      <span>{quote.bid.toFixed(digits)}</span>
                      <span className="text-slate-600 mx-1">/</span>
                      <span>{quote.ask.toFixed(digits)}</span>
                    </td>

                    <td className="py-3.5 px-4 text-end text-slate-400">
                      {quote.spread} pips
                    </td>
                    ...
                    <td className="py-3.5 px-4 text-end">
                      <span className="inline-flex items-center gap-1 text-blue-400 font-medium group-hover:translate-x-1 rtl:group-hover:-translate-x-1 transition-transform">
                        Terminal <ChevronRight size={13} className={direction === 'rtl' ? 'rotate-180' : ''} />
                      </span>
                    </td>
                  </tr>
                );
